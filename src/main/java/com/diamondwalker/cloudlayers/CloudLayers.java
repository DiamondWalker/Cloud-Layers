...
@Mod(CloudLayers.MODID)
public class CloudLayers
{
    // Define mod id in a common place for everything to reference
    public static final String MODID = "cloudlayers";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public CloudLayers(FMLJavaModLoadingContext context)
    {
    ...
    public static class ClientModEvents
    {
        ...
        public static void onEffectRegister(RegisterDimensionSpecialEffectsEvent event) {
            event.register(BuiltinDimensionTypes.OVERWORLD_EFFECTS, new CloudSky());
        }
    }
}
